...
interface SuggestionSidebarProps {
  ...
  onApplySuggestion: (suggestion: SpellingSuggestion, replacement: string) => void;
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-1 font-medium text-red-600">{suggestions.length}</span>
          </div>
          <div>
      ...
      <div className="flex-1">
        {suggestions.length === 0 ? (
          <div className="p-6 text-center text-gray-500">
            ...
            <p className="text-xs text-gray-400 mt-1">Great job with your spelling.</p>
          </div>
        ) : (
